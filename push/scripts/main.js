...
function onPushSubscription(e) {
    ...
    i.addEventListener("click", function() {
        var e = new FormData;
        e.append("subscriptionId", t), e.append("endpoint", s), fetch(PUSH_SERVER_URL + "/send_push", {
            method: "post",
            body: e
        }).then(function(e) {
    ...
    var n = 'curl --header "Authorization: key=' + API_KEY + '" --header Content-Type:"application/json" ' + s + ' -d "{\\"registration_ids\\":[\\"' + t + '\\"]}"',
        a = document.querySelector(".js-curl-code");
    a.innerHTML = n
}
